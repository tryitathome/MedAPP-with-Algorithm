...
launcher = 'none'
load_from = 'work_dirs/my_mouth_de_detr/save_45_94/epoch_50.pth'
log_level = 'INFO'
...
train_cfg = dict(max_epochs=56, type='EpochBasedTrainLoop', val_interval=10)
...
work_dir = './work_dirs\\my_mouth_de_detr'
